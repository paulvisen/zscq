<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CGJudge.aspx.cs" Inherits="cgjy.aspx.CGJudge" %>
...
<body>
    <form id="form1" runat="server">
        <div class="star" style="height: 170px;">
            <span style="display: inline-block;">成果评价</span><textarea name="txtjud" cols="55" rows="9" style="margin-left: 15px;"></textarea>
        </div>
        <div class="form-group">
            <span class="col-sm-2 control-label" style="display:inline-block;">图片上传</span>
