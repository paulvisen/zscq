...
{
    public partial class NewsManage : WebBase
    {
        ...
        public void getData()
        {
            ...
            DataTable dt = NewsDao.LoadNewsList(pageIndex, rowCount, -1, 1, sqlWhere);
            if (dt != null)
            {
                grid.DataSource = dt;
                grid.DataBind();
                int count = NewsDao.GetNewsListCount(-1, 1, sqlWhere);
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            {
                sqlWhere += " and SubType = " + SearchNewsType.SelectedIndex;
            }
