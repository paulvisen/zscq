<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserManage.aspx.cs" Inherits="zscq.Manage.UserManage" %>
                    ...
                    <asp:Repeater ID="grid" runat="server">
                        <ItemTemplate>
                            <tr>
                                ...
                                <td><%#Eval("Phone") %></td>
                                <td>
                                    <button class="btn btn-danger" onclick="deleteUser(<%#Eval(" UserID ") %>);return false;">删除</button>
                                </td>
                            </tr>
                        </ItemTemplate>
                    </asp:Repeater>
