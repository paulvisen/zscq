<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sellManager.aspx.cs" Inherits="zscq.Manage.chengguo.sellManager" %>
                    ...
                    <table class="table table-bordered">
                        <thead>
                            <tr style="text-align: center;">
                                ...
                                <%--<th style="text-align: center;">购买意愿</th>--%>
                            ...
                            <asp:Repeater ID="grid" runat="server">
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <%--读取id之后join用户数据库--%>
                                        <td style="text-align: center;"><%# Convert.ToDateTime(Eval("OpDate")).ToShortDateString()%></td>
                                        <td style="text-align: center;"><%# Eval("Price")%></td>
                                        <td style="text-align: center;"><%# Eval("Comm")%></td>
                                         <%--<td style="text-align: center;"><%# Eval("Sugg")%></td>--%>
                                        <td style="text-align: center;" class="center">
                                            <button type="button" class="btn btn-info" onclick="EditIn(<%# Eval("id") %>)">确认交易成功</button>&nbsp;&nbsp;&nbsp;&nbsp;
                                             <button type="button" class="btn btn-danger" onclick="EditIn(<%# Eval("id") %>)">关闭交易</button><%--要改--%>
