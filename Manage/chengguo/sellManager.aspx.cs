...
{
    public partial class sellManager : WebBase
    {
        ...
        public void getData()
        {
            ...
            string sqlWhere = "and LUserID=" + CGComponyid + " ";
            int iCount = 0; //数据总量
            ...
            if (ViewState["sqlWhere"] == null)
                sqlWhere = "and LUserID=" + CGComponyid + " ";
            else
                sqlWhere = ViewState["sqlWhere"].ToString();
            DB bll = new DB();
            DataTable dt = bll.GetDataSell(sqlWhere, pageindex * rowcount, rowcount, out iCount);
            if (dt != null)
            {
                grid.DataSource = dt;
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            {
                ViewState["sqlWhere"] = "and LUserID=" + CGComponyid + " ";
                if (SeaUName.Value.Trim() != "")
                {
