...
{
    public partial class selldoneManager : WebBase
    {
        ...
        public void getData()
        {
            ...
            string sqlWhere = "and JYUserID=" + CGComponyid + " ";
            int iCount = 0; //数据总量
            ...
            if (ViewState["sqlWhere"] == null)
                sqlWhere = "and JYUserID=" + CGComponyid + " ";
            else
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            {
                ViewState["sqlWhere"] = "and JYUserID=" + CGComponyid + " ";
                if (SeaUName.Value.Trim() != "")
                {
